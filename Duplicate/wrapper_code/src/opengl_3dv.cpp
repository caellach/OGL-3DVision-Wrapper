...
BOOL NV3DVisionBuffers_create(GLD3DBuffers *gl_d3d_buffers, void *window_handle, bool stereo)
{
	if (m_reInit == false && m_NV3DVisionInit == true)
	{
		...
		if (wddmSupport && (stereoSupport == 1))
		{
			...
			(*orig_glGenFramebuffers)(1, &gl_d3d_buffers->fbo_left);
			(*orig_glBindFramebuffer)(GL_FRAMEBUFFER, gl_d3d_buffers->fbo_left);
			(*orig_glFramebufferTexture2D)(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, gl_d3d_buffers->texture_left, 0);
			(*orig_glFramebufferTexture2D)(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, GL_TEXTURE_2D, gl_d3d_buffers->render_buffer, 0);
			(*orig_glFramebufferTexture2D)(GL_FRAMEBUFFER, GL_STENCIL_ATTACHMENT, GL_TEXTURE_2D, gl_d3d_buffers->render_buffer, 0);
			GLenum status_left = (*orig_glCheckFramebufferStatus)(GL_FRAMEBUFFER);


			GLenum status_right;
			if (gl_d3d_buffers->stereo)
			{
				(*orig_glGenFramebuffers)(1, &gl_d3d_buffers->fbo_right);
				(*orig_glBindFramebuffer)(GL_FRAMEBUFFER, gl_d3d_buffers->fbo_right);
				(*orig_glFramebufferTexture2D)(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, gl_d3d_buffers->texture_right, 0);
				(*orig_glFramebufferTexture2D)(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, GL_TEXTURE_2D, gl_d3d_buffers->render_buffer, 0);
				(*orig_glFramebufferTexture2D)(GL_FRAMEBUFFER, GL_STENCIL_ATTACHMENT, GL_TEXTURE_2D, gl_d3d_buffers->render_buffer, 0);
				status_right = (*orig_glCheckFramebufferStatus)(GL_FRAMEBUFFER);

			}

			// Used in flipping
			(*orig_glGenFramebuffers)(1, &m_auxFBO);
			(*orig_glBindFramebuffer)(GL_FRAMEBUFFER, m_auxFBO);
			(*orig_glGenTextures)(1, &m_auxTexture);
			(*orig_glBindTexture)(GL_TEXTURE_2D, m_auxTexture);
			(*orig_glTexImage2D)(GL_TEXTURE_2D, 0, GL_RGBA, g_width, g_height, 0, GL_RGBA, GL_UNSIGNED_BYTE, NULL);
			...
			(*orig_glFramebufferTexture2D)(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, m_auxTexture, 0);
			status_right = (*orig_glCheckFramebufferStatus)(GL_FRAMEBUFFER);
			// Used in flipping
...
void NV3DVisionBuffers_flipAndFlush(GLD3DBuffers *gl_d3d_buffers, GLuint rightFBO)
{
	...
	(*orig_glBindFramebuffer)(GL_DRAW_FRAMEBUFFER, gl_d3d_buffers->fbo_left);
	(*orig_glClear)(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);

	// This is the flipping
	(*orig_glBlitFramebuffer)(0, 0, g_width, g_height, 0, g_height, g_width, 0, GL_COLOR_BUFFER_BIT, GL_NEAREST);
	...
	// Flip Right
	// Read to our FBO
	(*orig_glBindFramebuffer)(GL_READ_FRAMEBUFFER, rightFBO);
	//glBindFramebuffer(GL_READ_FRAMEBUFFER, 0);
	glReadBuffer(GL_COLOR_ATTACHMENT0);
	(*orig_glBindFramebuffer)(GL_DRAW_FRAMEBUFFER, gl_d3d_buffers->fbo_right);
...
void NV3DVisionBuffers_deactivate_depth(GLD3DBuffers *gl_d3d_buffers)
{
	...
	{
		(*orig_glBindFramebuffer)(GL_FRAMEBUFFER_EXT, 0);
...
void NV3DVisionBuffers_activate_left(GLD3DBuffers *gl_d3d_buffers)
{
	if (!m_NV3DVisionInit)
	{
		...
		{
			strcat_s(res, "TRUE");
			(*orig_glBindFramebuffer)(GL_FRAMEBUFFER_EXT, gl_d3d_buffers->fbo_left);
		}
		else
		{
			strcat_s(res, "FALSE");
...
void NV3DVisionBuffers_activate_right(GLD3DBuffers *gl_d3d_buffers)
{
	if (!m_NV3DVisionInit)
	{
		...
		{
			strcat_s(res, "TRUE");
			(*orig_glBindFramebuffer)(GL_FRAMEBUFFER_EXT, gl_d3d_buffers->fbo_right);
		}
		else
		{
			strcat_s(res, "FALSE");
...
void NV3DVisionBuffers_flip_left(GLD3DBuffers *gl_d3d_buffers)
{
	...
	{
		// Read to our FBO
		(*orig_glBindFramebuffer)(GL_READ_FRAMEBUFFER, gl_d3d_buffers->fbo_left);
		glReadBuffer(GL_COLOR_ATTACHMENT0);
		(*orig_glBindFramebuffer)(GL_DRAW_FRAMEBUFFER, m_auxFBO);
		(*orig_glClear)(GL_COLOR_BUFFER_BIT);

		// This is the flipping
		(*orig_glBlitFramebuffer)(0, 0, g_width, g_height, 0, 0, g_width, g_height, GL_COLOR_BUFFER_BIT, GL_NEAREST);

		// Put the flipped image in the Back buffer
		(*orig_glBindFramebuffer)(GL_READ_FRAMEBUFFER, m_auxFBO);
		(*orig_glBindFramebuffer)(GL_DRAW_FRAMEBUFFER, gl_d3d_buffers->fbo_left);

		(*orig_glClear)(GL_COLOR_BUFFER_BIT);
		(*orig_glBlitFramebuffer)(0, 0, g_width, g_height, 0, g_height, g_width, 0, GL_COLOR_BUFFER_BIT, GL_LINEAR);
		(*orig_glBindFramebuffer)(GL_FRAMEBUFFER, gl_d3d_buffers->fbo_left);
...
void NV3DVisionBuffers_flip_right(GLD3DBuffers *gl_d3d_buffers)
{
	...
	{
		// Read to our FBO
		(*orig_glBindFramebuffer)(GL_READ_FRAMEBUFFER, gl_d3d_buffers->fbo_right);
		glReadBuffer(GL_COLOR_ATTACHMENT0);
		(*orig_glBindFramebuffer)(GL_DRAW_FRAMEBUFFER, m_auxFBO);
		(*orig_glClear)(GL_COLOR_BUFFER_BIT);
