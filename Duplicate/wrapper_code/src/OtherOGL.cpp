...
configReader *g_reader;
 ...
 func_glGenFramebuffers_t orig_glGenFramebuffers;
 func_glFramebufferTexture_t orig_glFramebufferTexture;
 func_glFramebufferTexture2D_t orig_glFramebufferTexture2D;
 func_glCheckFramebufferStatus_t orig_glCheckFramebufferStatus;

 // Stereo Calls ID5
 func_glDrawElementsBaseVertex_t orig_glDrawElementsBaseVertex;
 func_glBlitFramebuffer_t	orig_glBlitFramebuffer;
 
 // Texture
 func_glBindMultiTexture_t orig_glBindMultiTexture;
 func_glTexImage2DMultisample_t orig_glTexImage2DMultisample;
 func_glTextureSubImage2D_t orig_glTextureSubImage2D;
